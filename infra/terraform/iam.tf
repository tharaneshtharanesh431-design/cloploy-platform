...
resource "aws_iam_policy" "alb_ingress" {
  name        = "cloploy-eks-alb-ingress-policy"
...
resource "aws_iam_role" "alb_ingress" {
  name = "cloploy-eks-alb-ingress-role"
...
resource "aws_iam_policy" "autoscaler" {
  name        = "cloploy-eks-autoscaler-policy"
...
resource "aws_iam_role" "autoscaler" {
  name = "cloploy-eks-autoscaler-role"
...
resource "aws_iam_policy" "external_dns" {
  name        = "cloploy-eks-external-dns-policy"
  description = "Permissions for ExternalDNS"
  policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      {
...
resource "aws_iam_role" "external_dns" {
  name = "cloploy-eks-external-dns-role"
